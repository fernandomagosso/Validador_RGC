...
const App = () => {
  ...
  return (
    React.createElement(React.Fragment, null,
      ...
      React.createElement(InstructionModal, {
      ...
      React.createElement("header", null,
        React.createElement("h1", null, "Validador de Documentos com IA"),
        React.createElement("div", { className: "header-actions" },
            React.createElement("button", { className: "btn btn-primary", onClick: triggerCsvUpload },
              "Carregar CSV"
            ),
            ...
            csvData && anatelCodes.length > 0 && (
                React.createElement("div", { className: "filter-group" },
                    React.createElement("label", { htmlFor: "anatel-filter" }, "Filtrar por Cód. Anatel:"),
      ...
      React.createElement("main", { className: "container", ref: mainContainerRef },
        React.createElement("div", { className: "panel csv-panel", style: { width: `${sidebarWidth}px` } },
          React.createElement("div", { className: "panel-header" },
            React.createElement("span", null, "Dados CSV"),
            csvData && (
              React.createElement("input", {
                type: "text",
           ...
           React.createElement("div", { className: "panel preview-panel" },
            ...
            React.createElement("div", { className: "panel-content document-preview-container" },
                templateHtml && csvData && displayedRows.length > 0 ? (
                    ...
                    React.createElement("div", { className: "template-error-container" },
                       React.createElement("p", { className: "template-error" }, templateError)
                    )
                ) : csvData && displayedRows.length === 0 ? (
                    React.createElement("div", { className: "placeholder-text" },
                        React.createElement("p", null, "Nenhum registro encontrado para o filtro selecionado.")
                    )
                ) : (
